...
--- Membuat nilai yang ada di troley berubah sama dengan nilai yang ada pada card :----
...
--Mencoba Memisahkan component card dan menggabungkannya untuk fungsi yang sama seperti di atas :---

 Mengupdate sebuah parents melalui child component kita bisa menggunakan props yang berupa function , kita dapat membuat file di product.jsx dengan format sebagai berikut :
...
Dan dapat memisahkan cardnya melalui file lain sebagai berikut :
